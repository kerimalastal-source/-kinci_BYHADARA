/**
 * All 81 Turkish provinces (il) with their full official districts (ilçe).
 * `value` is a generated ASCII slug (Turkish characters folded) used as the
 * <select> option value; `label` is the proper Turkish name shown to users
 * in every language — place names aren't translated per-locale on this site.
 */
...
const RAW_PROVINCES: [string, string[]][] = [
  ...
  ["Erzurum", ["Aziziye", "Aşkale", "Çat", "Hınıs", "Horasan", "İspir", "Karaçoban", "Karayazı", "Köprüköy", "Narman", "Oltu", "Olur", "Palandöken", "Pasinler", "Pazaryolu", "Şenkaya", "Tekman", "Tortum", "Uzundere", "Yakutiye"]],
  ...
  ["İstanbul", ["Adalar", "Arnavutköy", "Ataşehir", "Avcılar", "Bağcılar", "Bahçelievler", "Bakırköy", "Başakşehir", "Bayrampaşa", "Beşiktaş", "Beykoz", "Beylikdüzü", "Beyoğlu", "Büyükçekmece", "Çatalca", "Çekmeköy", "Esenler", "Esenyurt", "Eyüpsultan", "Fatih", "Gaziosmanpaşa", "Güngören", "Kağıthane", "Kadıköy", "Kartal", "Küçükçekmece", "Maltepe", "Pendik", "Sancaktepe", "Sarıyer", "Silivri", "Sultanbeyli", "Sultangazi", "Şile", "Şişli", "Tuzla", "Ümraniye", "Üsküdar", "Zeytinburnu"]],
  ...
  ["Sinop", ["Ayancık", "Boyabat", "Dikmen", "Duragan", "Erfelek", "Gerze", "Saraydüzü", "Sinop Merkez", "Türkeli"]],
  ["Sivas", ["Akıncılar", "Altınyayla", "Divriği", "Doğanşar", "Gemerek", "Gölova", "Gürün", "Hafik", "İmranlı", "Kangal", "Koyulhisar", "Sivas Merkez", "Suşehri", "Şarkışla", "Ulaş", "Yıldızeli", "Zara"]],
  ...
  ["Trabzon", ["Akçaabat", "Araklı", "Arsin", "Beşikdüzü", "Çarşıba", "Çaykara", "Dernekpazarı", "Düzköy", "Hayrat", "Köprübaşı", "Maçka", "Of", "Ortahisar", "Sürmene", "Şalpazarı", "Tonya", "Vakfıkebir", "Yomra"]],
  ...
  ["Aksaray", ["Ağaçören", "Aksaray Merkez", "Eskil", "Gülağaç", "Güzelyurt", "Ortaköy", "Sarıyahşi", "Sultanhanı"]],
...
export const turkeyProvinces: Province[] = RAW_PROVINCES.map(([label, districts]) => ({
  value: slugify(label),
  label,
  districts: districts.map((d) => ({ value: slugify(d), label: d }))
