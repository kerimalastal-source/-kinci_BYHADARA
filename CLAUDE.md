...
- `src/data/blog.ts`: 10 مقالات مدونة عقارية حقيقية المحتوى (استثمار عقاري بتركيا، الجنسية عبر الاستثمار، الحياة بتركيا، إجراءات الطابو، الضرائب والرسوم، التثمين العقاري...) بكل اللغات الأربعة، بصور توضيحية مولّدة بالذكاء الاصطناعي (Canva)، مستضافة محلياً بـ `public/images/blog/`. **ملاحظة**: النسخ الأصلية على Wix كانت صغيرة جداً (200×133 بكسل فقط)، فالأغلفة بتطلع مغبّشة شوي بالعرض الكبير — الأفضل تُستبدل لاحقاً بنسخ أعلى دقة (≥1536×1024).
...
- [x] نقل الصور من Wix لاستضافة الموقع نفسه (`public/images/`) — تم 2026-09-26، ما في أي رابط Wix متبقي بالكود. (`static.wixstatic.com` صار متاح من بيئة Claude — كان محجوب سابقاً.) المتبقي بس: أغلفة المدونة دقتها منخفضة (200×133) من الأصل.
