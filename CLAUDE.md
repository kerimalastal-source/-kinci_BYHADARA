...
| تفاصيل مشروع | `/projects/:slug` | `projectDetail.ts` | ترتيب الأقسام: hero (شارات + زرّين "أنا مهتم"/واتساب) ← شريط الأرقام ← جولة بالفيديو (إذا في `video`) ← نظرة عامة (مطوية على الموبايل) ← أبرز المميزات ← الوحدات ← توزيع الطوابق ← المرافق ← الموقع ← معرض الصور؛ وعلى الجنب (وتحت بالموبايل) أهم المعلومات + كرت "مهتم بالمشروع؟"؛ وبالآخر مشاريع أخرى (صف قابل للسحب بالموبايل) |
